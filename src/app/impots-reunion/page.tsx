...
export const metadata: Metadata = {
  title: "Impôts à La Réunion : abattement DOM 30% | RécupMesEuros",
  description:
    "Guide complet sur l'abattement fiscal DOM de 30% à La Réunion : plafond 2 450 €, conditions de résidence, exemple chiffré et erreurs fréquentes.",
};

const faqData = [
  {
    question: "Quel est le montant de l'abattement fiscal à La Réunion ?",
    answer:
      "Les contribuables domiciliés à La Réunion (974) bénéficient d'un abattement de 30% sur leurs revenus imposables, plafonné à 2 450 € par an.",
  },
  {
    question: "Faut-il habiter à La Réunion toute l'année pour en bénéficier ?",
    answer:
      "Non, il faut être domicilié fiscalement à La Réunion au 31 décembre de l'année d'imposition. C'est votre résidence principale au 31/12 qui détermine votre éligibilité.",
  },
  {
    question: "Quels justificatifs fournir pour prouver sa résidence à La Réunion ?",
    answer:
      "Vous devez pouvoir présenter des justificatifs de domicile : factures d'énergie, avis de taxe foncière ou d'habitation, attestation d'assurance habitation, bail ou titre de propriété à La Réunion.",
  },
  {
    question: "L'abattement DOM est-il cumulable avec d'autres réductions d'impôt ?",
    answer:
      "Oui, l'abattement DOM s'applique sur l'IR brut, avant les réductions et crédits d'impôt. Vous pouvez donc cumuler l'abattement avec d'autres dispositifs fiscaux (dons, emploi à domicile, etc.).",
  },
];

export default function ImpotsReunion() {
  return (
    <>
      <Header />
      <main className="flex-1">
        ...
        <article className="max-w-3xl mx-auto px-4 py-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-6">
            Impôts à La Réunion : abattement DOM de 30%
          </h1>

          <p className="text-text-light mb-8 text-lg">
            Les contribuables domiciliés à <strong>La Réunion (974)</strong> bénéficient d&apos;un
          ...
          <section className="mb-10">
            ...
            <p className="text-text-light mb-4">
              ...
              sur le revenu pour compenser le coût de la vie plus élevé. À La Réunion, cet abattement est
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-text-light">
              <li>Être <strong>domicilié fiscalement à La Réunion au 31 décembre</strong> de l&apos;année d&apos;imposition</li>
              <li>La Réunion doit être votre <strong>résidence principale</strong></li>
          ...
          <section className="mb-10">
            ...
            <p className="text-text-light mb-4">
              ...
              fiscale si votre adresse est bien enregistrée à La Réunion. Vous n&apos;avez pas de case
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-text-light">
              <li>Factures d&apos;énergie (EDF, eau) à votre adresse à La Réunion</li>
              ...
              <li>Relevés bancaires mentionnant votre adresse réunionnaise</li>
            </ul>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-text-light">
              <li><strong>Adresse non mise à jour :</strong> si vous avez déménagé à La Réunion en cours d&apos;année, vérifiez que votre adresse au 31/12 est bien enregistrée</li>
              ...
              <li><strong>Double domicile :</strong> si vous avez un logement en métropole et à La Réunion, c&apos;est le lieu de votre résidence principale au 31/12 qui compte</li>
