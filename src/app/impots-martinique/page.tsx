...
export const metadata: Metadata = {
  title: "Impôts en Martinique : abattement DOM 30% | RécupMesEuros",
  description:
    "Guide complet sur l'abattement fiscal DOM de 30% en Martinique : plafond 2 450 €, conditions de résidence, cases à remplir, exemple chiffré et erreurs fréquentes.",
};

const faqData = [
  {
    question: "Quel est le montant de l'abattement fiscal en Martinique ?",
    answer:
      "Les contribuables domiciliés en Martinique (972) bénéficient d'un abattement de 30% sur leurs revenus imposables, plafonné à 2 450 € par an.",
  },
  {
    question: "Faut-il habiter en Martinique toute l'année pour en bénéficier ?",
    answer:
      "Non, il faut être domicilié fiscalement en Martinique au 31 décembre de l'année d'imposition. C'est votre résidence principale au 31/12 qui détermine votre éligibilité.",
  },
  {
    question: "Quels justificatifs fournir pour prouver sa résidence en Martinique ?",
    answer:
      "Vous devez pouvoir présenter des justificatifs de domicile : factures d'énergie, avis de taxe foncière ou d'habitation, attestation d'assurance habitation, bail ou titre de propriété en Martinique.",
  },
  {
    question: "L'abattement DOM est-il appliqué automatiquement par les impôts ?",
    answer:
      "Oui, si votre adresse fiscale est bien enregistrée en Martinique, l'abattement est calculé automatiquement par l'administration. Vérifiez cependant que votre avis d'imposition mentionne bien l'abattement.",
  },
];

export default function ImpotsMartinique() {
  return (
    <>
      <Header />
      <main className="flex-1">
        ...
        <article className="max-w-3xl mx-auto px-4 py-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-6">
            Impôts en Martinique : abattement DOM de 30%
          </h1>

          <p className="text-text-light mb-8 text-lg">
            Les contribuables domiciliés en <strong>Martinique (972)</strong> bénéficient d&apos;un
          ...
          <section className="mb-10">
            ...
            <p className="text-text-light mb-4">
              ...
              sur le revenu pour compenser le coût de la vie plus élevé. En Martinique, cet abattement est
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-text-light">
              <li>Être <strong>domicilié fiscalement en Martinique au 31 décembre</strong> de l&apos;année d&apos;imposition</li>
              <li>La Martinique doit être votre <strong>résidence principale</strong></li>
          ...
          <section className="mb-10">
            ...
            <p className="text-text-light mb-4">
              ...
              fiscale si votre adresse est bien enregistrée en Martinique. Vous n&apos;avez pas de case
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-text-light">
              <li>Factures d&apos;énergie (EDF, eau) à votre adresse en Martinique</li>
              ...
              <li>Relevés bancaires mentionnant votre adresse martiniquaise</li>
            </ul>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-text-light">
              <li><strong>Adresse non mise à jour :</strong> si vous avez déménagé en Martinique en cours d&apos;année, vérifiez que votre adresse au 31/12 est bien enregistrée</li>
              ...
              <li><strong>Double domicile :</strong> si vous avez un logement en métropole et en Martinique, c&apos;est le lieu de votre résidence principale au 31/12 qui compte</li>
