...
export const QUESTIONS: Question[] = [
  ...
  {
    id: "don_montant_politique",
    section: "Dons et mécénat",
    sectionIcon: "🎗️",
    text: "Montant total des dons aux partis politiques en 2025 ?",
    subtext: "Réduction de 66%, plafonnée à 15 000 € de dons par an.",
    type: "number",
    field: "don_montant_politique",
    placeholder: "Ex : 500",
    suffix: "€",
    showIf: (a) => !!a.don_parti_politique,
  },
  {
  ...
  // ─── Denormandie ───
  {
    ...
    section: "Investissement immobilier",
    sectionIcon: "🏗️",
    text: "Durée d'engagement de location Denormandie ?",
    type: "select",
    field: "denormandie_duree",
    options: [
      { value: "6", label: "6 ans" },
      { value: "9", label: "9 ans" },
      { value: "12", label: "12 ans" },
  ...
  {
    id: "loc_avantages_revenus",
    section: "Investissement immobilier",
    sectionIcon: "🏗️",
    text: "Revenus bruts fonciers du bien conventionné Loc'Avantages ?",
    subtext: "Loyers annuels perçus sur ce bien (avant charges).",
    type: "number",
    field: "loc_avantages_revenus",
    placeholder: "Ex : 8000",
    suffix: "€",
    showIf: (a) => a.loc_avantages === true,
  },
  ...
  // ─── Girardin ───
  {
    ...
    showIf: (a) => ["martinique", "guadeloupe", "guyane", "reunion", "mayotte"].includes(a.territory as string),
  },
  {
    id: "girardin_montant",
    section: "Investissement Outre-mer",
